...
#   timestamp: 2025-01-29T22:09:04+00:00
...
class NamespacedExtension(BaseModel):
    """
    JSON schema extending MxlimsData. To be subclassed
    """
...
class UnattendedCollection(Enum):
    """
    If this shipment is for unattended collection, then this property must be present and true. Otherwise, it must be absent and a <code>session</code> must be present.
    """
...
class CrystalData(MxlimsData):
    ...
    mxlims_type: Literal["Crystal"] = Field(
        "Crystal", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class PinPositionData(MxlimsData):
    ...
    mxlims_type: Literal["PinPosition"] = Field(
        "PinPosition", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class PinData(MxlimsData):
    ...
    mxlims_type: Literal["Pin"] = Field(
        "Pin", description="The type of MXLIMS object.", title="Mxlims Type"
    )
    barcode: Optional[str] = Field(None, description="The Pin barcode or RFID code")
    number_positions: Optional[conint(ge=1)] = Field(
        1, description="The number of positions available in the Pin."
    )
...
class PuckData(MxlimsData):
    ...
    mxlims_type: Literal["Puck"] = Field(
        "Puck", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class DewarData(MxlimsData):
    ...
    mxlims_type: Literal["Dewar"] = Field(
        "Dewar", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class WellDropData(MxlimsData):
    ...
    mxlims_type: Literal["WellDrop"] = Field(
        "WellDrop", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class PlateWellData(MxlimsData):
    ...
    mxlims_type: Literal["PlateWell"] = Field(
        "PlateWell", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class PlateData(MxlimsData):
    ...
    mxlims_type: Literal["Plate"] = Field(
        "Plate", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class ShipmentData(MxlimsData):
    ...
    mxlims_type: Literal["Shipment"] = Field(
        "Shipment", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class MxlimsObject(BaseModel):
    ...
    version: Literal["0.3.0"] = Field(
        "0.3.0", description="MXLIMS version for current model", title="Version"
    )
    uuid: UUID = Field(
...
class DropRegionData(MxlimsData):
    ...
    mxlims_type: Literal["DropRegion"] = Field(
        "DropRegion", description="The type of MXLIMS object.", title="Mxlims Type"
    )
...
class MxExperimentMessage(BaseModel):
    """
    Message containg one MxExperiment and its saample and logistical sample
    """

    job: MxExperiment = Field(
        ...,
        description='MxExperiment, with included results. Job may contain subjobs.',
        title='MxExperiment job',
    )
    sample: CrystallographicSample = Field(
        ...,
        description='Prepared Sample on which experiment was performed.',
        title='Prepared Samples',
    )
    logistical_sample: Union[Crystal, PinPosition, DropRegion, WellDrop] = Field(
        ...,
