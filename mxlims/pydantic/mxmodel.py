...
#   timestamp: 2025-03-18T16:40:03+00:00
...
class Circle(BaseModel):
    ...
    region_type: RegionType1 = Field(..., alias="regionType")
    center: Point
...
class Line(BaseModel):
    ...
    region_type: RegionType2 = Field(..., alias="regionType")
...
class Rectangle(BaseModel):
    ...
    region_type: RegionType3 = Field(..., alias="regionType")
    points: List[Point] = Field(..., max_length=2, min_length=2)
...
class Polygon(BaseModel):
    ...
    region_type: RegionType4 = Field(..., alias="regionType")
